...
const DescripcionLibro = () => (
    <section className="container__DescripcionLibro">
        ...
        <p>
            ...
            se ha extendido su uso por todo el mundo. En pocos años, 
            la Web ha evolucionado enormemente: se ha pasado de páginas 
        ...
        <p>
            Este libro es adecuado para cualquiera que tenga interés en aprender 
            a desarrollar sus propias páginas web. No son necesarios conocimientos 
...
export default DescripcionLibro