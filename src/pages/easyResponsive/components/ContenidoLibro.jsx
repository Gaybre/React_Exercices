...
const ContenidoLibro = () => (
    <section className="eResponsive_container__ContenidoLibro eResponsive_section">
        <h2 className="eResponsive_h2">Contenido del libro</h2>
        <p className="eResponsive_p">
            El contenido de este libro se estructura en tres apartados bien diferenciados:
        </p>

        <ul>
            <li className="eResponsive_li">
